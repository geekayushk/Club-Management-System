                ...
                <div class="signup-content">
                    <form method="POST" id="signup-form" class="signup-form">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="wname" id="name" placeholder="Event Name" required />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                           <h3 class="form-input" style="opacity: 0.35;"> Event Date : <input type="date" name="date" required/></h3> 
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="time" id="email" placeholder=" Event Timing "required/>
                        </div>
                        <div class="form-group">
